...
import '../../../routes.dart';
import '../widgets/move_to_pigeonhole_scanner.dart';
     ...
     appBar: CustomAppBar(context: context,title: AppTexts.moveMedia,),
      ...
      body: LayoutBuilder(
          builder:  (BuildContext context,BoxConstraints constraints) =>  Obx(() =>  Padding(
              ...
              child:controller.isLoading.value == MoveMediaLoadingType.hide ? Column(
...
Widget _pigeonHoleListing(){
  ...
  return ListView.builder(
    shrinkWrap: true,
    itemCount: controller.moveMediaLocationsModel.data!.stock!.length,
    itemBuilder: (BuildContext context, int index){
        Stock pigeoHoleStockList = controller.moveMediaLocationsModel.data!.stock![index];
